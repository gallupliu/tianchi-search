...
config_path = '/Users/gallup/data/bert/%s/bert_config.json' % model_name
if model_type == 'NEZHA':
    checkpoint_path = '/Users/gallup/data/bert/%s/model.ckpt-691689' % model_name
elif model_type == 'NEZHA-large':
    checkpoint_path = '/Users/gallup/data/bert/%s/model.ckpt-346400' % model_name
else:
    checkpoint_path = '/Users/gallup/data/bert/%s/bert_model.ckpt' % model_name
dict_path = '/Users/gallup/data/bert/%s/vocab.txt' % model_name
